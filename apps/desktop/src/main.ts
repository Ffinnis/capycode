...
import { RotatingFileSink } from "@capycode/shared/logging";
...
const APP_USER_MODEL_ID = "com.capycode.app";
...
async function checkForUpdatesFromMenu(): Promise<void> {
  ...
  if (updateState.status === "up-to-date") {
    void dialog.showMessageBox({
      ...
      message: `Capycode ${updateState.currentVersion} is currently the newest version available.`,
      buttons: ["OK"],
    });
