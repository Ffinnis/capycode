...
import { CodexModelSelection } from "@capycode/contracts";
...
import { normalizeCodexModelOptionsWithCapabilities } from "@capycode/shared/model";
...
const makeCodexTextGeneration = Effect.gen(function* () {
  ...
  const writeTempFile = (
    ...
    return fileSystem
      .makeTempFileScoped({
        prefix: `capycode-${prefix}-${process.pid}-${randomUUID()}.tmp`,
      })
      .pipe(
