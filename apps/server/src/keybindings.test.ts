import { KeybindingCommand, KeybindingRule, KeybindingsConfig } from "@capycode/contracts";
...
import { KeybindingsConfigError } from "@capycode/contracts";
    ...
    Layer.provideMerge(
      Layer.fresh(
        ServerConfig.layerTest(process.cwd(), {
          prefix: "capycode-keybindings-test-",
        }),
      ),
    ),
  );
