...
import { createModelSelection, normalizeModelSlug } from "@capycode/shared/model";
...
import { UnifiedSettings } from "@capycode/contracts/settings";
  ...
  const claudeThinking =
    claudeCandidate?.thinking === true
      ...
      : claudeCandidate?.thinking === false
        ? false
        : undefined;
  const claudeEffort: ClaudeCodeEffort | undefined = isClaudeAgentEffort(claudeCandidate?.effort)
