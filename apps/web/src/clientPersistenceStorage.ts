...
export const CLIENT_SETTINGS_STORAGE_KEY = "capycode:client-settings:v1";
export const SAVED_ENVIRONMENT_REGISTRY_STORAGE_KEY = "capycode:saved-environment-registry:v1";
