...
import { type ScopedThreadRef, type ThreadId } from "@capycode/contracts";
...
interface PersistentThreadTerminalSurfaceProps {
  threadRef: ScopedThreadRef;
  threadId: ThreadId;
  visible: boolean;
  mode: "drawer" | "surface";
  launchContext: ThreadTerminalLaunchContext | null;
...
export const PersistentThreadTerminalSurface = memo(function PersistentThreadTerminalSurface({
  threadRef,
  threadId,
  visible,
  mode,
  ...
  onMoveToSurface,
  onDockToDrawer,
}: PersistentThreadTerminalSurfaceProps) {
  ...
  return (
    <div className={visible ? undefined : "hidden"}>
      <ThreadTerminalDrawer
        ...
        enableSelectionActions={Boolean(onAddTerminalContext)}
        onMoveToSurface={onMoveToSurface}
        onDockToDrawer={onDockToDrawer}
      />
    </div>
  );
});
