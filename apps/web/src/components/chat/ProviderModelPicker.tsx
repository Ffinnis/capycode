import { type ProviderKind, type ServerProvider } from "@capycode/contracts";
import { resolveSelectableModel } from "@capycode/shared/model";
...
const PROVIDER_ICON_BY_PROVIDER: Record<ProviderPickerKind, Icon> = {
  codex: getProviderBrandIcon("codex"),
  claudeAgent: getProviderBrandIcon("claudeAgent"),
  cursor: CursorIcon,
};
