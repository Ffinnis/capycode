import { MessageId } from "@capycode/contracts";
...
describe("MessagesTimeline", () => {
  ...
  it("renders multiline reasoning rows in extended trace mode", async () => {
    const { MessagesTimeline } = await import("./MessagesTimeline");
    const markup = renderToStaticMarkup(
      <MessagesTimeline
        hasMessages
  ...
  it("surfaces current-turn trace entries in the live working block", async () => {
    const { MessagesTimeline } = await import("./MessagesTimeline");
    const markup = renderToStaticMarkup(
      <MessagesTimeline
        hasMessages
        ...
        timelineEntries={[
          {
            ...
            message: {
              ...
              role: "assistant",
              text: "I am checking the contracts.",
              createdAt: "2026-03-17T19:12:28.000Z",
              streaming: false,
            },
          },
          {
            ...
            entry: {
              ...
              createdAt: "2026-03-17T19:12:31.000Z",
              label: "Ran command",
              command: "sed -n '1,160p' packages/contracts/src/git.ts",
              tone: "tool",
            },
          },
        ]}
    ...
    expect(markup).toContain("Live trace");
    expect(markup).toContain("Ran command");
    expect(markup).toContain("Working for 10s");
  });
});
